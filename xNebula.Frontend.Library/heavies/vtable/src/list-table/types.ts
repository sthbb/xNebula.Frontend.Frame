...
// table 事件
export type EventType = keyof typeof ListTable.EVENT_TYPE;
export type EventHandler<P extends EventType> = TYPES.TableEventListener<
  (typeof ListTable.EVENT_TYPE)[P]
>;
...
// table 配置
export type Options = TYPES.ListTableConstructorOptions;

// table 实例
export type Instance = InstanceType<typeof ListTable>;
...
// 对外暴露方法，TYPES.ListTableAPI 没有 Instance 全面
export type Expose = {
  execMethod: Method<Instance>; // Method<TYPES.ListTableAPI>;
  readAttribute: Attribute<Instance>; // Attribute<TYPES.ListTableAPI>;
